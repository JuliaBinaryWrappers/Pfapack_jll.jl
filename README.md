...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/3e733ce3dac97d644361855065c968dc0f3dff62/P/Pfapack/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `Linux armv6l {call_abi=eabihf, julia_version=1.10.0, libc=glibc}` (`armv6l-linux-gnueabihf-julia_version+1.10.0`)
...
* `Linux armv6l {call_abi=eabihf, julia_version=1.10.0, libc=musl}` (`armv6l-linux-musleabihf-julia_version+1.10.0`)
...
* `Linux armv7l {call_abi=eabihf, julia_version=1.10.0, libc=glibc}` (`armv7l-linux-gnueabihf-julia_version+1.10.0`)
...
* `Linux armv7l {call_abi=eabihf, julia_version=1.10.0, libc=musl}` (`armv7l-linux-musleabihf-julia_version+1.10.0`)
...
* `Linux i686 {julia_version=1.10.0, libc=musl}` (`i686-linux-musl-julia_version+1.10.0`)
